...
import time,sys,socket,threading,logging,urllib.request,random,http, signal,sock,socket,pyttsx3,platform
# Clear the terminal
...
class MainLoop():
    ...
    def setup(self):
        ...
        while True:        
            url = input('Enter the target url \x1b[38;5;202m=> \x1b[38;5;226m')
        ...
        while True:            
            try:
                l = str(input('\x1b[38;5;118mEnter the list of proxy \x1b[38;5;202m=> \x1b[38;5;226m'))
                in_file = open(l,"r")
                lista = []
                for i in in_file:
        ...
        while True:                
            try:
                num_threads = int(input('\x1b[38;5;118mEnter the number of thread \x1b[38;5;202m=> \x1b[38;5;226m'))
            except:
                num_threads = 999999
            break
